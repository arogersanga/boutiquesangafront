...
export const menuItems = [
    ...
    new Menu (25, 'ADMIN_NAV.AFFICHAGES', '/admin/products/affichage', null, 'remove_red_eye', null, false, 20),
    new Menu (22, 'ADMIN_NAV.PRODUCT_LIST', '/admin/products/product-list', null, 'list', null, false, 20),
    new Menu (26, 'ADMIN_NAV.SLIDES', '/admin/products/slides', null, 'remove_red_eye', null, false, 20),
    new Menu (27, 'ADMIN_NAV.BANNERS', '/admin/products/banners', null, 'remove_red_eye', null, false, 20),
