...
export const sidenavMenuItems = [
  ...
  new SidenavMenu(20, 'Gros Bracelets', '/products/bracelets/grosbracelets', null, null, false, 12),
  new SidenavMenu(21, 'Petits Bracelets', '/products/petitsbracelets', null, null, false, 12),
  new SidenavMenu(22, 'Portes clés Personnalisés', '/products/portescles/portesclespersonnalises', null, null, false, 14),
  new SidenavMenu(23, 'Autres Portes clés', '/products/portescles/autresportescles', null, null, false, 14),
  new SidenavMenu(24, 'Afrique Map', '/products/bouclesoreilles/afriquemap', null, null, false, 11),
  new SidenavMenu(25, 'Forme Coeur', '/products/bouclesoreilles/formecoeur', null, null, false, 11),
  new SidenavMenu(26, 'Forme Feuille', '/products/bouclesoreilles/formefeuille', null, null, false, 11),
  new SidenavMenu(27, 'Forme Losange', '/products/bouclesoreilles/formelosange', null, null, false, 11),
  new SidenavMenu(28, 'Forme Pomme', '/products/bouclesoreilles/formepomme', null, null, false, 11),
